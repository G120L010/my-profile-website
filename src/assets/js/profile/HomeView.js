...
export function useHomeView() {
  ...
  const experiences = ref([
    {
      id: 1, // 經歷唯一識別碼 (確保不可重複)
      company: 'USR大學永續發展暨社會責任辦公室', // 公司或接案單位名稱
      role: 'USR永續發展暨社會責任辦公室人員', // 擔任的技術職稱
      period: '2023.08 - 2025.07', // 在職起迄年月區間
      tags: ['申請與執行研究計畫', '研討會/講座活動規劃與執行', '辦公室行政', '網路活動規劃與執行'], // 所使用到的核心技術標籤，會自動在卡片底部生成膠囊徽章
      summary: '專責與執行研究計畫', // 具體的工作職責與貢獻說明
