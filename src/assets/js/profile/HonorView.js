...
export function useHonorView() {
  ...
  const honors = ref([
    ...
    },
    {
      ...
      accentClass: 'accent-purple',
      summary: '歷年學業總平均成績為88.18分（A），四技資訊工程系畢業，實得總學分數136學分。'
    },
    {
      id: 8,
      title: '大學部系排名次證明書',
    ...
    },
    {
      ...
      accentClass: 'accent-gold',
      summary: '學業成績表現優良，榮獲財團法人吳林盡教育基金會大專組獎學金。'
    },
    {
      id: 10,
      title: '111學年度畢業典禮群育獎獎狀',
      issuer: '崑山科技大學',
      date: '2023.06',
      stage: 'university',
      stageName: '大學',
    ...
    {
      id: 14,
      title: '2023 DLT 數位生活科技研討會論文發表證明書',
      issuer: '國立高雄科技大學',
      date: '2023.05',
      stage: 'university',
      stageName: '大學',
    ...
    },
    {
      ...
      accentClass: 'accent-gold',
      summary: '熱心社會服務、表現傑出，經遴選當選為中華民國112年大專優秀青年。'
    },
    {
      id: 19,
      title: '111年度高等教育深耕計畫e-Portfolio達人競賽優等獎狀',
      issuer: '崑山科技大學',
      date: '2022.12',
      stage: 'university',
      stageName: '大學',
    ...
    },
    {
      ...
      accentClass: 'accent-gold',
      summary: '敦品勵學、奮發向上，學業成績表現優良，榮獲陳忠陳葉蕊文教基金會獎學金。'
    },
    {
      id: 22,
      title: '110年青年志工團隊競賽青年組績優服務獎狀',
      issuer: '教育部青年發展署',
      date: '2022.03',
      stage: 'university',
      stageName: '大學',
    ...
    },
    {
      ...
      accentClass: 'accent-purple',
      summary: '四技資訊工程系在校學業表現卓越，於110學年度第1學期學期成績優異，特頒此狀以資鼓勵。'
    },
    {
      id: 24,
      title: '第五屆鴻海獎學鯨大專院校獎助學金證書',
      issuer: '鴻海教育基金會',
      date: '2021.12',
      stage: 'university',
      stageName: '大學',
      ...
      accentClass: 'accent-gold',
      summary: '展現求學熱誠、學業成績優異，榮獲中華民國110年第五屆鴻海獎學鯨大專院校獎助學金。'
    },
    {
      id: 25,
      title: '2021 TSIA 國際美業菁英賽最佳設計獎狀',
      issuer: '中華沙龍產業發展協會',
      date: '2021.12',
      stage: 'university',
      stageName: '大學',
    ...
    },
    {
      ...
      accentClass: 'accent-purple',
      summary: '以研發作品《智能生活安全防疫用紫外線殺菌系統》參賽，榮獲萬潤2021創新創意競賽佳作。'
    },
    {
      id: 28,
      title: '109學年度第2學期學業成績優良獎狀',
      issuer: '崑山科技大學',
      date: '2021.09',
      stage: 'university',
      stageName: '大學',
      ...
      accentClass: 'accent-purple',
      summary: '四技資訊工程系在學學業表現優異，名列前茅，於109學年度第2學期榮獲學業成績優異獎狀。'
    },
    {
      id: 29,
