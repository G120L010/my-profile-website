...
export function useCertificationView() {
  ...
  const certifications = ref([
    ...
    },
    {
      ...
      issuer: '財團法人工業技術研究院 iPAS',
      date: '2025.06',
      credentialId: '****************',
      verifyUrl: 'https://talent.ipas.org.tw/',
      image: 'images/Portfolioimg/no-image.jpg',
      accentClass: 'accent-tools',
      summary: '榮登經濟部 iPAS 雙軸能力鑑定（淨零碳與人工智慧）獲證名單，受邀參與工研院及104舉辦之專場實體課程與活動。'
    },
    {
      id: 5,
      title: '產物保險業務員',
    ...
    },
    {
      ...
      date: '2024.05',
      credentialId: '****************',
      verifyUrl: 'http://www.tipci.org.tw/',
      image: 'images/Portfolioimg/no-image.jpg',
      accentClass: 'accent-tools',
    ...
    },
    {
      ...
      date: '2023.03',
      credentialId: '****************',
      verifyUrl: 'http://www.siliconstone.com/',
      image: 'images/Portfolioimg/no-image.jpg',
      accentClass: 'accent-design',
