...
export function useAboutView() {
  ...
  const educations = ref([
    ...
    },
    {
      ...
      status: '畢業',
      desc: '奠定基本電腦操作與資訊能力，學習多媒體創作與網際網路基礎知識，期間因家庭因素導致經濟狀況困難，參與多項校內工讀事務，仍積極擔任環境生態教育服務社社長，期間表現傑出，榮獲鴻海獎學鯨、全國大專優秀青年，入選總統教育獎推薦名單。'
    },
    {
      id: 3,
      school: '亞洲餐旅',
      ...
      status: '畢業',
      desc: '擁有餐飲管理實務操作基礎，並考取餐旅服務、中餐烹飪、飲料調製、烘焙食品（麵包）等多張丙級技術證照。'
    }
  ])
