...
| 2026.07.22 | **全站人流計數器 Bug 深度審查與雙 API 備援機制重構** | [App.vue](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/App.vue)<br>[App.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/App.js)<br>[App.css](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/css/App.css)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | 深度排查並徹底修復人流計數器三大隱性 Bug（Promise.all 連鎖崩潰、零值 0||1 轉型錯誤、未點擊與跨日 session 判定失準）及初始化閃爍問題。 | (1) 將 Promise.all 改採 Promise.allSettled 獨立處理日/月/年/總 4 個 Key，防止單一 Key 失敗拖垮全盤；(2) 引入雙雲端提供者架構 (Miles Hilliard CountAPI + CounterAPI.dev 雙備援)；(3) 修正 count===0 轉型為 1 之 falsy 隱患；(4) 導入 sessionStorage 日期精準追蹤與 LocalStorage 快取預載防止閃爍 0；(5) 100% 恪守繁體中文與無 Emoji 註解規範。 |
