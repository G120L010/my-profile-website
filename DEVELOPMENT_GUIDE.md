...
| 2026.07.23 | **行動端按鈕文案精簡優化 (履歷/聯繫、Resume/Contact、履歴書/連絡先)** | [zh-TW.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/locales/zh-TW.js)<br>[en.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/locales/en.js)<br>[ja.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/locales/ja.js)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | 原先各語系按鈕文字較長（如 `View Resume` / `Contact Me`、`履歴書を見る` / `お問い合わせ`），在手機等窄螢幕寬度下容易發生卡片內按鈕文字爆字換行或撐開跑版問題。 | 精簡三個語系檔中的按鈕文案：(1) 繁中改為 `履歷` / `聯繫`；(2) 英文改為 `Resume` / `Contact`；(3) 日文改為 `履歴書` / `連絡先`；大幅提升行動端視覺精緻度與防止排版跑版。 |
