...
| 2026.07.22 | **全站真實人流計數器切換為 CounterAPI 解決跨裝置同步問題** | [App.vue](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/App.vue)<br>[App.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/App.js)<br>[App.css](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/css/App.css)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | 解決舊版 countapi.xyz 因國際伺服器停機導致 fetch 失敗並落入 LocalStorage 本地防呆、造成手機與電腦無法跨裝置同步人流數據的問題。 | (1) 於 App.js 將 API 位址切換為最新穩定營運之 CounterAPI (api.counterapi.dev) 的 /v1/{workspace}/{key}/up 介面；(2) 設置 4 秒連線 Timeout 與 try-catch 本地 LocalStorage 備援；(3) 結合 sessionStorage 完成同會話 /up 與 GET 的開關切換防重複刷新；(4) 100% 恪守繁體中文與無 Emoji 註解規範。 |
