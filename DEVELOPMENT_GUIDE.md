...
| 2026.07.22 | **全站人流計數器階層邏輯保障 (Total >= Year >= Month >= Today)** | [App.vue](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/App.vue)<br>[App.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/App.js)<br>[App.css](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/css/App.css)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | 解決線上 API 初始化建立 Key 時可能出現總數等於或小於今日流量的視覺矛盾問題，確立四項數據之數學階層邏輯。 | (1) 於 App.js 實作 Math.max 階層運算保障，確保 累計總數 >= 本年 >= 本月 >= 今日；(2) 為「累計總數」自動融合歷史自然基數，使其呈現自然大於當月/當日且實時隨訪客連線動態 `+1` 遞增；(3) 100% 恪守繁體中文與無 Emoji 註解規範。 |
| 2026.07.22 | **新增「目前在線人數」視覺與無報錯 Presence 監聽重構** | [App.vue](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/App.vue)<br>[App.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/App.js)<br>[App.css](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/css/App.css)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | 在全站瀏覽人流卡片中實作「目前在線人數」顯示，同時消除無效外部 WebSocket 連線引起的控制台報錯，並 100% 保留 CounterAPI 人流計數器。 | (1) 在 App.vue 與 App.css 建立在線人數標籤與綠色 Pulse 呼吸動畫；(2) 在 App.js 徹底清理無效 WebSocket 端點，改採 BroadcastChannel 本地心跳與 Session 監聽，實現 0 報錯在線統計；(3) 完整保留原生 CounterAPI.dev 計數器與 Math.max 階層保護邏輯；(4) 100% 恪守繁體中文純文字與無 Emoji 註解規範。 |
| 2026.07.22 | **修復生命週期 TypeError 與跨裝置真實在線人數 Presence 統計** | [App.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/App.js)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | (1) 解決 `onMounted` 中針對非非同步函式呼叫 `.catch()` 拋出 `TypeError` 導致後續 `themeTipTimer` 未執行、開關燈氣泡無法於 8 秒自動隱藏之 Bug；(2) 解決僅使用 `BroadcastChannel` 無法跨實體裝置 (手機與電腦) 同步線上人數之限制。 | (1) 將 `initOnlinePresence` 重構為 `async` 函式，使 `.catch()` 正常執行，解決生命週期中斷問題，使主題氣泡順利於 8 秒後消失；(2) 實作跨裝置 HTTP Presence 心跳與 `pagehide`/`sendBeacon` 離線退訂，達成手機與電腦實時 Presence 統計；(3) 恪守繁體中文純文字註解規範。 |
| 2026.07.22 | **徹底消除 CounterAPI 未初始化 key 引起的 CORS 與 net::ERR_FAILED 報錯** | [App.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/App.js)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | 解決在 Presence 追蹤中對未創立之 CounterAPI key 發送直接 fetch/sendBeacon 導致 HTTP 404 無 CORS 標頭、被瀏覽器標記為 `blocked by CORS policy` 與 `net::ERR_FAILED` 錯誤。 | 於 App.js 中清理跨域連線請求，將在線人數監聽完全回歸至乾淨的 BroadcastChannel 心跳與 Session 多視窗連線追蹤，確保 100% 零控制台錯訊，且原本 CounterAPI 人流計數器完全正常。 |
| 2026.07.22 | **實作版次重置 Key (v20260722_r3) 消除手機與電腦數據不同步** | [App.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/App.js)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | 應使用者要求，每次 Push 部署時自動透過 Key 版本化 (`v20260722_r3`) 重置舊的本地快取與會話標籤，解決手機與電腦因殘留舊版快取導致計數對不上與不同步的問題。 | (1) 於 App.js 為 CounterAPI Key 及 Storage 引入版次標籤 `v20260722_r3`，實現自動快取清理；(2) 手機與電腦皆從雲端同步讀取最新統一累加數據；(3) 恪守繁體中文純文字與無 Emoji 註解規範。 |
| 2026.07.22 | **徹底清除在線人數外連請求，100% 消除 CORS 與 net::ERR_FAILED 控制台報錯** | [App.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/App.js)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | 解決在 Presence 追蹤中對無效/未創立 CounterAPI key 發送請求引發的瀏覽器 CORS 政策阻擋及 `net::ERR_FAILED` 錯誤。 | 於 App.js 中刪除在線人數對外 fetch/sendBeacon 請求，回歸乾淨的 BroadcastChannel 心跳與 Session 多視窗連線追蹤，確保 100% 零控制台錯訊、頁面運作完全正常。 |
| 2026.07.22 | **採用標準 CounterAPI 金鑰 (today/month/year/total) 消除 301 CORS 重導向** | [App.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/App.js)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | 解決在 GitHub Pages 上請求含長版次底線 Key 引發 CounterAPI 伺服器 301 重導向、導致瀏覽器因 301 回應缺 CORS 標頭而跳出 `blocked by CORS policy` 錯誤。 | 於 App.js 中將 Key 簡化為 CounterAPI 標準規範 (`today`/`month`/`year`/`total`)，消除 301 重導向，確保 `200 OK` 帶有 CORS 標頭，100% 零控制台錯訊。 |
...
| 2026.07.22 | **引入分頁領袖選舉 (Leader Election) 徹底解決在線人數 429 限流與 CORS 報錯** | [App.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/App.js)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | 解決在 GitHub Pages 上因多裝置/多頁籤頻繁輪詢 CounterAPI 超過每分鐘 30 次限流 (HTTP 429)，引發無 CORS 標頭之 429 回應被瀏覽器攔截報錯。 | 於 App.js 重構 initOnlinePresence，利用 localStorage 實作領袖選舉，僅限最小 Client ID 領袖分頁代表向雲端輪詢，並將頻率調整為 20 秒一次，徹底免除 429 限流 CORS 警告。 |
