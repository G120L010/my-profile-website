...
| **漸進式網頁應用 / PWA**<br>[manifest.json](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/public/manifest.json)<br>[sw.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/public/sw.js)<br>[index.html](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/index.html)<br>[App.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/App.js) | 🟢 已解構 | 🟢 已完成 | 🟢 已完成 | 🟢 已完成 | 🟢 已完成 | **100%** |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| ***以下為規劃中功能（依優先順序排列）*** | | | | | | |
| **聯絡表單 / Contact**<br>[ContactModal.vue](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/views/profile/ContactModal.vue)<br>[ContactModal.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/profile/ContactModal.js)<br>[ContactModal.css](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/css/profile/ContactModal.css)<br>[App.vue](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/App.vue)<br>[App.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/App.js) | 🟢 已解構 | 🟢 已完成 | 🟢 已完成 | 🟢 已完成 | 🟢 已完成 | **100%** |
...
| 2026.07.23 | **全站漸進式網頁應用 PWA (Progressive Web App) 離線快取與桌面/手機 App 安裝實作** | [manifest.json](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/public/manifest.json)<br>[sw.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/public/sw.js)<br>[index.html](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/index.html)<br>[App.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/App.js)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | 為了讓網站能像原生手機 App 與桌面軟體一樣「新增到主畫面/桌面」獨立全螢幕運行，並在無網路或離線環境下依然能 100% 順暢載入履歷內容。 | (1) 於 `public/manifest.json` 配置原生 Web App Manifest 標準：宣告獨立視窗 (`standalone`)、獨立主題色彩 (`#0d1117`)、專屬手繪書法墨韻質感 Han 字樣圖示 (`images/pwa_han_logo.png`) 與繁體中文 App 名稱 (`HanJohn 履歷`)；(2) 於 `public/sw.js` 實作零依賴原生 Service Worker 網路優先 (Network-First with Cache Fallback) 離線快取策略，確保有網時自動抓取最新資源、無網時無縫回退至本地快取；(3) 於 `index.html` <head> 注入 PWA manifest、`apple-touch-icon` 指向 `images/pwa_han_logo.png`、iOS Apple 獨立 App 狀態標籤與主題色彩；(4) 於 `App.js` 的 `onMounted` 生命週期中自動安全註冊 `./sw.js`。 |
| 2026.07.23 | **PWA 圖示相容性除錯、iOS apple-touch-icon 補齊與手繪書法質感 Logo 更換** | [manifest.json](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/public/manifest.json)<br>[index.html](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/index.html)<br>[pwa_han_logo.png](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/public/images/pwa_han_logo.png)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | (1) 舊長方形大頭照 me.jpg 與 .ico 格式不符合 Chrome PWA 的 1:1 正方形與 PNG 格式要求，導致瀏覽器拒絕觸發 beforeinstallprompt 安裝對話框；(2) iOS Safari 缺乏 apple-touch-icon 標籤，新增至主畫面時無法讀取專屬 App 圖示。 | (1) 於 public/manifest.json 配置標準 1:1 正方形 PNG 圖示條目 (images/pwa_han_logo.png)；(2) 於 index.html <head> 補齊 `<link rel="apple-touch-icon" href="images/pwa_han_logo.png">`，達成 iOS 與 Android 跨平台雙端 App 圖示統一；(3) 生成手繪書法墨韻風格之 Han 字樣 Logo 替換原始硬板 AI 科技背景，提升人文設計質感；(4) 移除未使用的 pdfExportTip 語系字典鍵值，維護代碼乾淨度。 |
| 2026.07.24 | **修復作品集 ID:4 與 ID:5 YouTube 影片網址與通用影音 embed 自動解析功能** | [PortfolioView.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/profile/PortfolioView.js)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | (1) 作品集 ID:4 與 ID:5 均加入 `vq=hd1080&hd=1` 參數優先請求 1080p 全高清畫質播放；(2) 內嵌於 iframe 時自動穩定串流高畫質影音內容。 | (1) 將 PortfolioView.js 中 ID:4 網址加入 `vq=hd1080&hd=1` 修正為 `https://www.youtube.com/embed/wb3JZ6l4Yt8?vq=hd1080&hd=1&si=KvotjwDoLcZWQNSi`；(2) 將 ID:5 網址加入 `vq=hd1080&hd=1` 修正為 `https://www.youtube.com/embed/6jYhcZNiiMY?vq=hd1080&hd=1&si=SupWVFe18lsfr3Bi`；(3) 保持 ID:6 原規範網址 `https://httpshancreator-springcom-2.creator-spring.com/` 不變；(4) 於 PortfolioView.js 實作 `getEmbedUrl` 防呆解析函式，自動將 YouTube 格式解析為可於 iframe 順暢播放的 `/embed/` 網址。 |
| 2026.07.24 | **聯絡表單 Modal 彈窗實作（精美 mailto 方案）** | [ContactModal.vue](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/views/profile/ContactModal.vue)<br>[ContactModal.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/profile/ContactModal.js)<br>[ContactModal.css](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/css/profile/ContactModal.css)<br>[App.vue](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/App.vue)<br>[App.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/assets/js/App.js)<br>[zh-TW.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/locales/zh-TW.js)<br>[en.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/locales/en.js)<br>[ja.js](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/src/locales/ja.js)<br>[DEVELOPMENT_GUIDE.md](file:///c:/Users/s1080/Desktop/JOHN/my-profile-website/DEVELOPMENT_GUIDE.md) | 原本「聯繫我」按鈕為純靜態 mailto: 連結，點擊後直接跳轉郵件軟體，HR 無法預先填寫姓名、公司、留言等結構化資訊；且行動裝置上體驗不夠精緻。 | (1) 實作三層分離 ContactModal 元件：`ContactModal.vue`（視圖層）、`ContactModal.js`（業務邏輯層）、`ContactModal.css`（樣式層）；(2) 採用 mailto 方案，完全不依賴任何第三方服務，GitHub Pages 部署零設定；(3) 表單欄位含姓名、信箱、服務單位（選填）、留言，送出後自動組合成標準 mailto URI 開啟訪客郵件軟體並預填資料；(4) 玻璃態設計、縮放淡入動畫、橘色焦點光暈、深淺色模式雙適配；(5) 三語系（繁中/英/日）字典新增 `contact` 命名空間；(6) `App.vue` 的「聯繫我」按鈕改為觸發 Modal，`App.js` 掛載 Modal 狀態管理並導出至 App.vue 模板綁定。 |
